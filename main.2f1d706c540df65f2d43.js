...
const renderDailyWeatherForecastForsevenDays = (future) => {
    ...
    future.forecastday.forEach((day) => {
        ...
        (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(day.date))
