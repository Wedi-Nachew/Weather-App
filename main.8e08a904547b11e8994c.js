...
const renderDailyWeatherForecastForsevenDays = (future, unit) => {
...
const renderHourlyWeatherForecast = (future, unit) => {
...
const getCurrentWeather = async (city) => {
    ...
    try {
        ...
        (0,_current_weather__WEBPACK_IMPORTED_MODULE_9__.renderCurrentWeatherInfo)(
            currentWeather,
            forecastWeather,
            locationDetails,
            unit
    ...
    getUserSearchLocation().adjustSearchingElements(
        _icons_magnifying_glass_10_svgrepo_com_svg__WEBPACK_IMPORTED_MODULE_7__,
        "black",
        ""
    );
};
